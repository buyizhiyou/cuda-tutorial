...
{
    extern __shared__ int tile[];//extern声明动态共享内存
...
{
    __shared__ int tile[BDIMY][BDIMX+IPAD];//padding减少冲突
    unsigned int idx=threadIdx.y*blockDim.x+threadIdx.x;
...
{
    extern __shared__ int tile[];//动态内存padding
...
int main(int argc,char** argv){
    ...
    switch (kernel)
    {
        case 0:{
            ...
            printf("setRowReadRow elapsed %f sec\n",iElaps);
            break;
        }
        case 1:{
            ...
            cudaDeviceSynchronize();
            iElaps=cpuSecond()-iStart;
            printf("setColReadCol elapsed %f sec\n",iElaps);
            break;
        }
        case 2:{
            ...
            cudaDeviceSynchronize();
            iElaps=cpuSecond()-iStart;
            printf("setRowReadCol elapsed %f sec\n",iElaps);
            break;
        }
        case 3:{
        ...
        case 4:
        {
            ...
            cudaDeviceSynchronize();
            iElaps=cpuSecond()-iStart;
            printf("setRowReadColDyn elapsed %f sec\n",iElaps);
            break;
        }
        case 5:
        {
            ...
            cudaDeviceSynchronize();
            iElaps=cpuSecond()-iStart;
            printf("setRowReadColIpad elapsed %f sec\n",iElaps);
            break;
        }
        case 6:
        {
            ...
            cudaDeviceSynchronize();
            iElaps=cpuSecond()-iStart;
            printf("setRowReadColDynIpad elapsed %f sec\n",iElaps);
            break;
        }
        case 7:
        {

...
__global__ void test_shfl_broadcast(int* in,int* out,int srcLans){
...
__global__ void test_shfl_down(int* in,int* out,int delta){
    int value=in[threadIdx.x];
    value=__shfl_down_sync(value,delta,BDIM);
    out[threadIdx.x]=value;
}

__global__ void test_shfl_wrap(int* in,int* out,int offset){
    int value=in[threadIdx.x];
...
__global__ void test_shfl_xor(int* in,int* out,int mask){
    int value=in[threadIdx.x];
    value=__shfl_xor_sync(value,mask,BDIM);
    out[threadIdx.x]=value;
}

__global__ void test_shfl_xor_array(int* in,int* out,int mask){
